            ...
            <div className="flex flex-col lg:flex-row flex-wrap items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start">
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mt-6 order-last lg:order-none"
                    >
                        <a
                            href={cvFile}
                ...
                {/* Right side: Image */}
                <div className="w-full lg:w-1/2 lg:p-8 flex justify-center order-first lg:order-none mb-6 lg:mb-0">
                    <motion.img
                        ...
                        src={profilePic}
                        alt="Yogev Ofir"
                        className="rounded-3xl w-48 sm:w-56 md:w-64 lg:w-90"
                    />
                </div>
            </div>
        </div>
